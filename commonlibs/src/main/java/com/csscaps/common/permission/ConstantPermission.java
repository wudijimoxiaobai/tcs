...
public interface ConstantPermission {
     ...
     * 登陆获取手机信息权限
     */
    String[] PERMISSIONS_READ_PHONE_STATE = new String[]{Manifest.permission.READ_PHONE_STATE};
   ...
   String[] PERMISSIONS_READ_WRITE=new String[]{Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.WRITE_EXTERNAL_STORAGE};
}
