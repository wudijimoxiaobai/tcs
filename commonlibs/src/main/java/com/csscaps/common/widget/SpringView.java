...
public class SpringView extends LinearLayout implements AbsListView.OnScrollListener, MyScrollView.OnScrollListener {
    ...
    private void initContentView() {
        ...
        if (view instanceof MyScrollView) {
            this.scrollView = (MyScrollView) view;
    ...
    public void onScroll(int scrollY) {
        ...
        if (scrollY != 0 && (scrollY + height) < scrollViewMeasuredHeight) {
            isTop = false;
            isBottom = false;
            isIntercept = false;
        }
