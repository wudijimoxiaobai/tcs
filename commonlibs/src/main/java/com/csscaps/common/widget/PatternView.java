...
import com.csscaps.common.utils.PatternUtils;
...
public class PatternView extends View {
    ...
    private static final String TAG = "LockGestureLockView";
    ...
    public PatternView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // Removed since every developer should set their own GestureLockViewStyle.
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // Log.v(TAG, "LockGestureLockView dimensions: " + viewWidth + "x" + viewHeight);
