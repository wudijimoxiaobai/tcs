...
import com.csscaps.tcs.utils.StatusBarUtils;
...
import static com.raizlabs.android.dbflow.sql.language.SQLite.caseWhen;
import static com.raizlabs.android.dbflow.sql.language.SQLite.select;

public class NewInvoiceActivity extends BaseActivity implements AdapterView.OnItemSelectedListener, Action1<Customer> {
    ...
    protected int getLayoutResId() {
        return R.layout.fragment_new_invoice;
    }
    ...
    private void initInvoiceType(String str) {
        ...
        if (invoiceType.getInvoiceObject() == 1) {
            mObject.setText("Business");
        } else if (invoiceType.getInvoiceObject() == 0) {
            mObject.setText("Special Consumer");
        } else if (invoiceType.getInvoiceObject() == 2) {
            mObject.setText("General Consumer");
        }
