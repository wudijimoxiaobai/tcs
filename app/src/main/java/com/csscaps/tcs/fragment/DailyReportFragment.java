...
public class DailyReportFragment extends BaseFragment implements AdapterView.OnItemClickListener {
    ...
    protected int getLayoutResId() {
        return R.layout.report_daily_report_fragment;
    }
    ...
    public static DailyReportFragment newInstance(String text) {
        DailyReportFragment fragment = new DailyReportFragment();
        Bundle args = new Bundle();
        args.putString("years1", text);
